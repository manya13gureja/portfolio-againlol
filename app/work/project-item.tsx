...
import type { Project } from "@/features/profile/types/project";
        ...
        <div className="flex items-center">
          {project.logo ? (
            <Image
              ...
              height={32}
              quality={100}
              className="mx-6 flex size-6 shrink-0 select-none"
              unoptimized
              aria-hidden="true"
            />
          ) : (
            <div
              className="mx-6 flex size-6 shrink-0 items-center justify-center text-muted-foreground select-none"
              aria-hidden="true"
            >
            ...
            <CollapsibleTrigger className="group/project flex w-full items-center gap-4 p-4 pr-2 text-left select-none">
              ...
              <SimpleTooltip content="Open Project Link">
                <a
                  ...
                  rel="noopener"
                >
                  <LinkIcon className="pointer-events-none size-6" />
                  <span className="sr-only">Open Project Link</span>
                </a>
              </SimpleTooltip>

              <div
                className="shrink-0 text-muted-foreground [&_svg]:size-6"
                aria-hidden
              >
